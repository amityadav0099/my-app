...
<button className="btn btn-primary mx-1" onClick={handleupClick} >{props.buttonname}</button>
<button className="btn btn-primary mx-1" onClick={handleLoClick} >{props.buttonname2}</button>
<button className="btn btn-primary mx-1" onClick={handleclearClick} >{props.buttonname3}</button>
