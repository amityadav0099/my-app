...
{/* <Routes>
    ...
    <Route exact path="/" element={ <Textform showAlert={showAlert} heading="Enter text here" mode={mode} buttonname="convertToUpperCase" buttonname2="convertToLowerCase" buttonname3="clear" />} />
  </Routes> */}
